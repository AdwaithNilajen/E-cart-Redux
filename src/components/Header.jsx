    ...
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white'>
        ...
        <ul className='flex-1 text-right'>
            ...
            <li className='list-none inline-block px-5'>
              <input onChange={(e)=>dispatch( searchProduct(e.target.value.toLowerCase()))} style={{width:"300px"}} className='rounded p-2 text-black' type="text" placeholder='Search Products Here...' ></input>
            </li>
            } 
          ...
          <li className='list-none inline-block px-5'>
            <Link to={'/cart'}>
            <i className='fa-solid fa-cart-plus text-green-600'></i>Cart <span className='bg-black text-white rounded p-1'>{userCart?.length}</span>
