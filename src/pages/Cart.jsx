                     ...
                     <table className='table-auto w-full'>
                      ...
                      <tbody>
                         <tr>
                            <td>1</td>
                            <td>Product name</td>
                            <td><img height={'70px'} width={'70px'} src="https://play-lh.googleusercontent.com/2QEKcIOLIO9HRoL6lWIVFEY_Y07oW1_5Zk0vvEHym1Wsxzhdjf0mJ6eMG8QBs66c0S8" alt="" /></td>
                            <td>
                              <div className='flex'>
                                <button className='font-bold'>-</button>
                                <input className='border p-1 rounded mx-2' style={{width:'40px'}} type="text" value={2} readOnly />
                                <button className='font-bold'>+</button>
                              </div>
                            </td>
                            <td>$ 100</td>
